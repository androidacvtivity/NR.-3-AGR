function sumCap1196_Rind010() {
    ...
    rind010Col1.val(sumCol1 !== 0.0 ? sumCol1.toFixed(1) : ""); // Assign empty string if sum is 0
    rind010Col2.val(sumCol2 !== 0.0 ? sumCol2.toFixed(1) : ""); // Assign empty string if sum is 0
    rind010Col3.val(sumCol3 !== 0.0 ? sumCol3.toFixed(1) : ""); // Assign empty string if sum is 0
    rind010Col4.val(sumCol4 !== 0.0 ? sumCol4.toFixed(1) : ""); // Assign empty string if sum is 0
    rind010Col5.val(sumCol5 !== 0.0 ? sumCol5.toFixed(1) : ""); // Assign empty string if sum is 0
...
//-------------------------------------------------------------------------------------------------
    ...
    // Calculate the sums for Row.020
    ...
    // Apply rounding and set the values
    var rind020Col1 = $("#73_1196_77667_020_3");
    var rind020Col2 = $("#73_1196_77667_020_4");
    var rind020Col3 = $("#73_1196_77667_020_5");
    var rind020Col4 = $("#73_1196_77667_020_6");
    var rind020Col5 = $("#73_1196_77667_020_7");


    rind020Col1.val(sumCol1 !== 0.0 ? sumCol1_020.toFixed(1) : ""); // Assign empty string if sum is 0
    rind020Col2.val(sumCol2 !== 0.0 ? sumCol2_020.toFixed(1) : ""); // Assign empty string if sum is 0
    rind020Col3.val(sumCol3 !== 0.0 ? sumCol3_020.toFixed(1) : ""); // Assign empty string if sum is 0
    rind020Col4.val(sumCol4 !== 0.0 ? sumCol4_020.toFixed(1) : ""); // Assign empty string if sum is 0
    rind020Col5.val(sumCol5 !== 0.0 ? sumCol5_020.toFixed(1) : ""); // Assign empty string if sum is 0

    // Make Rind.010 columns read-only
    rind020Col1.prop("readonly", true);
    rind020Col2.prop("readonly", true);
    rind020Col3.prop("readonly", true);
    rind020Col4.prop("readonly", true);
    rind020Col5.prop("readonly", true);
    ...
    rind080Col2.val(sumCol2_080 !== 0.0 ? sumCol2_080.toFixed(1) : ""); // Assign empty string if sum is 0
    rind080Col3.val(sumCol3_080 !== 0.0 ? sumCol3_080.toFixed(1) : ""); // Assign empty string if sum is 0
    rind080Col4.val(sumCol4_080 !== 0.0 ? sumCol4_080.toFixed(1) : ""); // Assign empty string if sum is 0
    rind080Col5.val(sumCol5_080 !== 0.0 ? sumCol5_080.toFixed(1) : ""); // Assign empty string if sum is 0
